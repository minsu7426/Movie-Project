...
public class TicketingDaoImpl implements TicketingDao {
	...
	public ReserveCompleteDto getReserveComplete(String code, String seat, String id) {
		String sql = "select ticket.tic_num, ticket.tic_payment, ticket.tic_seat, screen.scr_screen, screen.scr_time, screen.scr_date, movie.movie_title, movie.movie_img from ticket join screen on ticket.tic_code = screen.scr_code join movie on movie.movie_code = screen.scr_movie where scr_screen = ? and tic_seat = ? and tic_id = ?";
