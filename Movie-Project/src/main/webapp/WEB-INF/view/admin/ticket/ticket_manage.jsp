...
<body>
	...
	<div class="ticket_manage container">
		...
		<div align="center" class="search_container">
			<form method="post" action="/admin/ticket/ticket_manage">
				<table>
					<tr>
					...
					<li class="page-item"><c:choose>
							<c:when test="${pageDto.cri.page == index}">
								<a class="page-link" style="background-color: #ddd"
									href="/admin/ticket/ticket_manage?page=${index}&search_item=${pageDto.cri.search_item}&text=${pageDto.cri.text}">${index}</a>
							</c:when>
							<c:otherwise>
								<a class="page-link"
									href="/admin/ticket/ticket_manage?page=${index}&search_item=${pageDto.cri.search_item}&text=${pageDto.cri.text}">${index}</a>
