...
<style>
    ...
    * {
    ...
    .member_detail .info .info_form input,
    .member_detail .info .info_form select{
        width: 400px;
        height: 44px;
        border-radius: 5px;
...
<body>
	...
	<div class="member_detail container">
        ...
        <div class="info">
            <form class="info_form" action="/admin/member/updatemember" method="post">
                ...
                <div class="submit" align="right">
                    ...
                    <a href="/admin/member/membermanage" class="btn btn-primary">되돌아가기</a>
                     <a href="/admin/member/deletemember?memberId=${member.user_id }" class="btn btn-danger" onclick="return confirm('정말 삭제하시겠습니까?');">삭제</a>
                </div>
            </form>
        </div>
    </div>
